...
const checkboxLabelStyle = tva({
  base: 'text-typography-600 data-[checked=true]:text-typography-800 data-[hover=true]:text-typography-800 data-[hover=true]:data-[checked=true]:text-typography-800 data-[hover=true]:data-[checked=true]:data-[disabled=true]:text-typography-800 data-[hover=true]:data-[disabled=true]:text-typography-400 data-[active=true]:text-typography-800 data-[active=true]:data-[checked=true]:text-typography-800 data-[disabled=true]:opacity-40 web:select-none',
  parentVariants: {
    size: {
      lg: 'text-lg',
      md: 'text-base',
